...
public class Demo {
    public static void main(String[] args) {
        ...
        Project project3=new Project("SF",customer3);
        ...
        Employee employee_1 = new Employee("X1","A",new Date(),Position.DESIGNER,department1,ProjectDAO.getAll());
        Employee employee_2 = new Employee("X2","B",new Date(),Position.ANALYST,department2,ProjectDAO.getAll());
        Employee employee_3 = new Employee("X3","C",new Date(),Position.TEAM_LEAD,department1,ProjectDAO.getAll());
        Employee employee_4 = new Employee("X4","D",new Date(),Position.ANALYST,department3,ProjectDAO.getAll());

        ProjectDAO.add( project2);
        ProjectDAO.add( project3);
        ProjectDAO.add( project4);

        Employee employee_5 = new Employee("X5","E",new Date(),Position.ANALYST,department1,ProjectDAO.getAll());
        ...
        //System.out.println(Controller.projectsByEmployee(employee0));
